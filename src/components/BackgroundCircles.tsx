    ...
    <>
      ...
      <div
        className={`fixed -left-[30%] top-[80%] h-[60vmax] w-[60vmax] rounded-full bg-myblack transition-all duration-700 ease-in-out ${
          ...
          inView2
            ? "h-[90vmax] w-[90vmax] -translate-y-[110vmax] translate-x-[0vmax] transform sm:-translate-y-[100vmax] sm:translate-x-[26vmax] md:-translate-y-[105vmax] xl:-translate-y-[105vmax]"
            : ""
        } ${
          inView3 || inView4
            ? "translate-x-[20vmax] translate-y-[-105vmax] transform md:translate-x-[40vmax] md:translate-y-[-100vmax] lg:translate-x-[50vmax] lg:translate-y-[-85vmax]"
            : ""
